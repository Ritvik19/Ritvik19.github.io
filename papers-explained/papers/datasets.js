const datasets = [
  ...
  },
  {
    ...
    date: "March 2023",
    description:
      "A synthetic dataset of short stories, generated by GPT-3.5 and GPT-4, containing only words typically understood by 3- to 4-year-olds. It enables training and evaluation of much smaller language models (below 10 million parameters or one transformer block) that can still produce fluent, consistent, diverse stories with nearly perfect grammar.",
    tags: ["Datasets", "Synthetic Data"],
  },
  {
    title: "Obelics",
    link: "a581f8d909b6",
  ...
  },
  {
    ...
    date: "December 2023",
    description:
      "A synthetic dataset containing 12.3 million grade-school math problems paired with Python solutions, fully generated by GPT-3.5. After finetuning on TinyGSM, a duo of a 1.3B generation model and a 1.3B verifier model can achieve 81.5% accuracy, outperforming existing models that are orders of magnitude larger and rivaling the performance of the GPT-3.5 “teacher” model (77.4%).",
    tags: ["Datasets", "Synthetic Data", "Math"],
  },
  {
    title: "Dolma",
    link: "a656169269cb",
  ...
  },
  {
    ...
    date: "January 2024",
    description:
      "A RAG benchmark for complex multi-hop queries that require retrieving and reasoning over multiple documents. The dataset consists of a news article-based knowledge base, diverse multi-hop queries across inference, comparison, temporal, and null types, their ground-truth answers, and associated supporting evidence.",
  ...
  },
  {
    ...
    date: "February 2024",
    description:
      "A high-quality dataset containing 1,034 complex fan-out question-answer pairs and 7,305 human-annotated decompositions, designed to evaluate LLMs' abilities to perform multi-hop, multi-document reasoning using English Wikipedia as a knowledge base.",
    tags: ["Datasets", "Benchmark"],
  },
  {
    title: "WebSight",
  ...
  {
    title: "Comprehensive RAG Benchmark (CRAG)",
    link: "cff01593ce2d",
    date: "June 2024",
    description:
      "A factual question answering benchmark with 4,409 question-answer pairs and mock APIs simulating web and Knowledge Graph (KG) retrieval, designed to reflect realistic, diverse, and dynamic QA scenarios across five domains and eight question types.",
    tags: ["Datasets", "Benchmark"],
  },
  {
    title: "Numina Math",
  ...
  },
  {
    ...
    date: "September 2024",
    description:
      "A high-quality dataset of 824 challenging multi-hop questions designed to comprehensively evaluate LLMs on factual responses, retrieval capabilities, and reasoning within end-to-end RAG scenarios.",
    tags: ["Datasets", "Benchmark"],
  },
  {
    title: "PixMo",
  ...
  },
  {
    ...
    date: "January 2026",
    description:
      "A 900-prompt benchmark designed to rigorously evaluate AI agents on challenging, multi-step information-seeking tasks across 17 fields, emphasizing systematic collation of fragmented information, entity resolution (de-duplication), and reasoning about search stopping criteria.",
