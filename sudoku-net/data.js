...
let project_contents = {
    ...
    "Method": [
        ...
        {"type": "carousel", "images": [{"src": "sudokunet-architecture-ffn.png", "caption": "FFN Architecture"}, {"src": "sudokunet-architecture-cnn.png", "caption": "CNN Architecture"}]},
        {"type": "text", "content": "SudokuNet explores various neural network architectures, including Feed Forward Networks (FFN), Convolutional Neural Networks (CNN). The models are designed to predict the missing digits in Sudoku puzzles based on the available information. The architectures are optimized to capture the spatial dependencies and patterns present in Sudoku puzzles, enabling accurate predictions."},
        {"type": "text", "content": "The Sudoku puzzles are represented as 9x9 grids, with each cell containing a digit from 0 to 9. The input data is preprocessed by converting the digits to one-hot encoded vectors, resulting in a 9x9x10 tensor representation."},
    ...
    "Results": [
        ...
        {"type": "table", "columns": ["Model", "Accuracy"], "rows": [["ffn__64x2.keras", "92.93%"], ["ffn__64x4.keras", "92.92%"], ["ffn__128x2.keras", "92.96%"], ["ffn__128x4.keras", "92.89%"], ["cnn__64x2.keras", "92.79%"], ["cnn__64x4.keras", "93.03%"], ["cnn__128x2.keras", "92.78%"], ["cnn__128x4.keras", "92.87%"]]},
    ],
    "Conclusion": [
